 ...
 */
            ...
            /**
            *  FundTransferPanResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FundTransferPanResponse extends com.gtplimited.BaseResponseBody
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = FundTransferPanResponse
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FundTransferPanResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FundTransferPanResponse",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static FundTransferPanResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FundTransferPanResponse object =
                new FundTransferPanResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FundTransferPanResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FundTransferPanResponse)com.gtplimited.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  ValidateLast4Request bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ValidateLast4Request extends com.gtplimited.BaseRequestBody
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ValidateLast4Request
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ValidateLast4Request",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ValidateLast4Request",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static ValidateLast4Request parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidateLast4Request object =
                new ValidateLast4Request();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ValidateLast4Request".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidateLast4Request)com.gtplimited.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

...
/**
 * InstantRegistrationRequest.java
 *
 ...
 */
            ...
            /**
            *  InstantRegistrationRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InstantRegistrationRequest extends com.gtplimited.BaseRequestBody
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = InstantRegistrationRequest
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InstantRegistrationRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "InstantRegistrationRequest",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static InstantRegistrationRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InstantRegistrationRequest object =
                new InstantRegistrationRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InstantRegistrationRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InstantRegistrationRequest)com.gtplimited.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

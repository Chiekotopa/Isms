...
/**
 * TransactionActivityRequest.java
 *
 ...
 */
            ...
            /**
            *  TransactionActivityRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TransactionActivityRequest extends com.gtplimited.BaseRequestBody
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = TransactionActivityRequest
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for NumberOfTrans
                        */

                        
                                    protected int localNumberOfTrans ;
                           ...
                           */
                           public  int getNumberOfTrans(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param NumberOfTrans
                               */
                               public void setNumberOfTrans(int param){
                            
                                            this.localNumberOfTrans=param;
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TransactionActivityRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "TransactionActivityRequest",
                           xmlWriter);
                   }
                              ...
                              if (localStartDateTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://gtplimited.com/";
                                    writeStartElement(null, namespace, "NumberOfTrans", xmlWriter);
                             
                                               if (localNumberOfTrans==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("NumberOfTrans cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNumberOfTrans));
                                               }
    ...
    public static class Factory{
        ...
        */
        public static TransactionActivityRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TransactionActivityRequest object =
                new TransactionActivityRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TransactionActivityRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TransactionActivityRequest)com.gtplimited.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://gtplimited.com/","StartDate").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://gtplimited.com/","EndDate").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://gtplimited.com/","NumberOfTrans").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"NumberOfTrans" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setNumberOfTrans(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
